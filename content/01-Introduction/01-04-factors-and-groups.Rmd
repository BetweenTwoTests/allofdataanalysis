...
You often see terms like _between-subject and _within-subject_ What are they and how do they relate to experiment design?
...
```{r one-IV-two-levels-vs-DV, echo = FALSE}
df_oneIV <- tribble(
  ~Control  , ~Experiment,
...
```{r two-IVs-two-levels-vs-DV, echo = FALSE}
df_twoIV <- tribble(
  ~""            ,       ~"",               ~Control,            ~Experiment,
